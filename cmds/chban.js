exports.run = async (message, args)=> {
  ...
  let chbanroomid2 =config.blacklistnganhdata["ch"].banroom2id
  let chbanchannel2 = client.channels.cache.get(chbanroomid2);
