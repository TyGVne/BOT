exports.run = async (message, args)=> {
  ...
  let banroomid = config.blacklistnganhdata["ch"].banroomid
  let banchannel = client.channels.cache.get(banroomid);
  
  let banroom2id = config.blacklistnganhdata["ch"].banroom2id
  let banchannel2 = client.channels.cache.get(banroom2id);


  let banlogid = config.blacklistnganhdata["ch"].banlogid
  ...
  let chuban1embed = new Discord.MessageEmbed()
